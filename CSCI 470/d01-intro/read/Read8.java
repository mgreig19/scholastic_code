...
public class Read8
{
  ...
  public static void main(String[] args)
  {
    ...
    try
      {
        inputFile = new Scanner(Paths.get("data2.txt"));
      }
    ...
    try
        ...
        while (inputFile.hasNext())
	  {
	    ...
	    // get number
	    // FORGOT TO SEE IF THERE IS A NEXT ELEMENT
		...
		// FORGOT TO CHECK FOR NUMERIC - v. 2
		inputNum2 = sc.nextInt();
		System.out.printf("num is %d%n", inputNum2);
